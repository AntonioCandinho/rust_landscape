...
fn given_some_example_landscape() {
    ...
    assert_eq!(landscape.get_segments(), vec![
        Segment { height: 3, rain: 0 },
        Segment { height: 1, rain: 3 },
        Segment { height: 6, rain: 0 },
        Segment { height: 4, rain: 3 },
        Segment { height: 8, rain: 0 },
        Segment { height: 9, rain: 0 },
    ]);

    landscape.rain(1);
    assert_eq!(landscape.get_segments(), vec![
        Segment { height: 3, rain: 2 },
        Segment { height: 1, rain: 5 },
        Segment { height: 6, rain: 1 },
        Segment { height: 4, rain: 4 },
        Segment { height: 8, rain: 0 },
        Segment { height: 9, rain: 0 },
    ]);
